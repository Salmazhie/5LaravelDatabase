            ...
            <div class="p-5 bg-light rounded-3 col-xl-4 border">
                ...
                <div class="row">
                    <div class="col-md-12 d-grid">
                        <a href="<?php echo e(route('employee.index')); ?>" class="btn btn-outline-dark btn-lg mt-3"><i class="bi-arrow-left-circle me-2"></i> Back</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\ASUS\OneDrive\Desktop\ControllerView\resources\views/employee/show.blade.php ENDPATH**/ ?>